...
new XMLHttpRequest;a.onreadystatechange=function(){if(4===a.readyState&&200===a.status){var b=JSON.parse(a.responseText);g.statisticElem.innerHTML=k.format('<span style="display: none;">\u53c2\u4e0e\u4eba\u6570\uff1a{0}\u4eba</span><span class="curtain-info-right">LightGame</span>',b.count)}};a.open("GET","statistic.php",!0);a.send()},start:function(){this.curtainElem.style.display="none";this.waitTime=180;this.isParse=!1;this.changeGrade(0);this.createMatrix();m.clearRect(0,

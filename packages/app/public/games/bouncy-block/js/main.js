...
GameOverScene = $.extend({}, Scene, {
    ...
    start: function() {
        ...
        this.share = game.add.button(game.world.centerX, 730 + d, "share", function() {
            ...
            if (window.parent && window.parent !== window) {
            ...
            } else if (typeof window.handleGlobalShare === 'function') {
                ...
                if (navigator.share) {
                    navigator.share({
                        title: 'Bouncy Block',
                        text: `I scored ${score} in Bouncy Block! Can you beat my score?`,
                        url: window.location.href
                    }).catch(() => {});
                } else {
                    // Copy to clipboard as fallback
                    const shareText = `I scored ${score} in Bouncy Block! Can you beat my score? ${window.location.href}`;

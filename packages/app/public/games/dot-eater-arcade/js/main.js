...
var main_state = {
	...
	update: function() {
		...
		if (this["cursors"]["left"]["isDown"] || this["wasd"]["left"]["isDown"]) {
			this["dragger"]["x"] -= speed * this["game"]["time"]["physicsElapsed"];
		}
		if (this["cursors"]["right"]["isDown"] || this["wasd"]["right"]["isDown"]) {
			this["dragger"]["x"] += speed * this["game"]["time"]["physicsElapsed"];
		}
		if (this["cursors"]["up"]["isDown"] || this["wasd"]["up"]["isDown"]) {
			this["dragger"]["y"] -= speed * this["game"]["time"]["physicsElapsed"];
		}
		...
		if (this["dragger"]["x"] < 0) this["dragger"]["x"] = 0;
		if (this["dragger"]["x"] > 289) this["dragger"]["x"] = 289;
		if (this["dragger"]["y"] < 0) this["dragger"]["y"] = 0;
		if (this["dragger"]["y"] > 449) this["dragger"]["y"] = 449;

...
function g( id ) {    var el = document.getElementById( id );    return el || { style: {}, onclick: null, addEventListener: function(){}, innerHTML: "", value: "" };}g( "start" ).onclick = start;
...
g( "share" ).onclick = function () {   g( "share-mask" ).style.display = "block";};if (endgame.env.ee) {    g( "share" ).style.display = "none";}

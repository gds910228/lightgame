...
function IsPC() {
    console.log('IsPC() called, returning:', /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ? false : true);
...
game.prototype.ts = function(a) {
    ...
    var scaleY = Attack.pos_y / rect.height;

    if (a.targetTouches && a.targetTouches.length > 0) {
        a = a.targetTouches[0];
    }

    Attack._x = (a.pageX - rect.left) * scaleX;
    Attack._y = (a.pageY - rect.top) * scaleY;
...
game.prototype.tmove = function(a) {
    a.preventDefault();
    console.log('Touch move event triggered', a.pageX, a.pageY);
    var canvas = document.getElementById('myCanvas');
    var rect = canvas.getBoundingClientRect();
    var scaleX = 320 / rect.width;
    var scaleY = Attack.pos_y / rect.height;
...
game.prototype.tmove2 = function(a) {
    console.log('Mouse move event triggered', a.pageX, a.pageY);
    var canvas = document.getElementById('myCanvas');
    var rect = canvas.getBoundingClientRect();
    var scaleX = 320 / rect.width;
    var scaleY = Attack.pos_y / rect.height;
...
game.prototype.start = function() {
    console.log('game.start() called, binding events to canvas');
    this.mub_list = [null, null, null, null, null, null, null, null, null],
    this.all_mub = "000000000",
    this.player=Attack.gd?new free(160,600,92,80,Attack.imgDx[65],2):new plane(160,600,66,51,Attack.imgDx[63],2);
    var a = new stage(0, "STAGE 2", 2, 570, Attack.imgDx[32]);
    ...
    Attack.drObj();
    var c = this.c;
    console.log('canvas element:', c, 'IsPC:', IsPC());
    IsPC() ? (c.removeEventListener("mousemove", this.tmove2, !1), c.addEventListener("mousemove", this.tmove2, !1), console.log('Bound mousemove event to canvas')) : (c.removeEventListener("touchstart", this.ts, !1), c.removeEventListener("touchmove", this.tmove, !1), c.addEventListener("touchstart", this.ts, !1), c.addEventListener("touchmove", this.tmove, !1), console.log('Bound touch events to canvas'));
